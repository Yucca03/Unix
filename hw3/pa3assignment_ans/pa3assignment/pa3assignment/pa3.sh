...
alias w='~/trydoor; BacktrackTest e >& ~/X && cd .. || cd w >& ~/X && l||nogo;\
         chmod u-x ~/pa3assignment/pa3assignment/pa3/start/e/e/n/w'

# The following 3 commands were in programming assignment 2 (although the dig
# command has been improved to test for whether you hold the shovel).
alias i='echo You currently have:;head -1q ~/pa3assignment/pa3assignment/pa3/items/??[^xumbirdfs]*'
alias sleep='cat .sleep 2> ~/X || \
            echo "You try to sleep standing up, but cannot manage it."'
alias dig='ls ~/pa3assignment/pa3assignment/pa3/items/shovel>& ~/X && (mv .platinum platinum 2> ~/X &&echo\
...
alias get='~/pa3assignment/pa3assignment/get'
alias drop='~/pa3assignment/pa3assignment/drop'
alias x='~/pa3assignment/pa3assignment/exam'
alias reset='~/pa3assignment/pa3assignment/reset'
alias put='~/pa3assignment/pa3assignment/put'
alias cut='~/pa3assignment/pa3assignment/cut'
...
alias game='cd ~/pa3assignment/pa3assignment; chmod u+x pa3assignment/pa3assignment/pa3/start/e/e/n/w >& ~/X; rm -r ~/pa3assignment/pa3assignment/pa3>&~/X;\
            tar -xf rooms.tar >& ~/X; cd ~/pa3assignment/pa3assignment/pa3/start; chmod u-x e/e/n/w; clear;\
	    l; PS1="> "'

# This command "quits" the game. It creates a "$ " prompt to indicate this.
alias quit='score;cd ~/pa3assignment/pa3assignment;unalias l look BacktrackTest nogo n e w s ne nw se sw i\
...
alias score='expr ` find ./treasures -name "??[la]*" | wc -l` \* 10'
alias flush='ls urinal >& ~/X || echo "there being nothing to flush";ls urinal >& ~/X && (mv ~/holdtreasure/* ~/X;echo "Whoosh\!\!";echo "\n";score;)' 
