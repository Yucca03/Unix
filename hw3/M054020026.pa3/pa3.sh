...
alias score= 'expr `ls -1 ~/pa3/treasures | wc -l` \* 10'
alias flush='ls urinal >& ~/X && echo "there being nothing to flush";ls urinal >& ~/X && (mv ~/pa3/holdtreasure/* ~/pa3/treasure;echo Whoosh\!\!;echo "\n";score;);' 
